...
| 4096 sampled stats | `reports/precision/matmul_stats_4096x4096x4096_profiles.json`, `reports/verification/matmul_stats_profiles.log`, `sim/run_submission_regression.ps1` | Archived profile sweep covers finite_exp8, finite_exp32, finite_exp64, and sparse_nonfinite. Fast acceptance treats it as baseline evidence; release mode reruns scripts. | Baseline evidence present; release freshness depends on running without `-SkipLongStats`. |
