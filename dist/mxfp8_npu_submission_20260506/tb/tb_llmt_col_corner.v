...
module tb_llmt_col_corner;
  ...
  localparam [31:0] FP32_MIN_SUB = 32'h00000001;
  localparam [31:0] FP32_TWO_MIN_SUB = 32'h00000002;
  ...
  initial begin
    ...
    fill_block(E4M3_POS_ONE, E4M3_POS_ONE, E8M0_EXP_NEG77, E8M0_EXP_NEG77);
    pulse_valid(1'b1);
    wait_for_output();
    check_acc(FP32_MIN_SUB, "fp32 min subnormal dot");

    fill_block(E4M3_POS_ONE, E4M3_POS_ONE, E8M0_EXP_NEG77, E8M0_EXP_NEG77);
    pulse_valid(1'b0);
    wait_for_output();
    check_acc(FP32_TWO_MIN_SUB, "fp32 subnormal accumulator");
